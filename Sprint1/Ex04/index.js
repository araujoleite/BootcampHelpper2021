...
function carregaLista(lista) {
    ...
    lista.forEach(function (pessoa) {
        ...
        btDelete.onclick = function (event) { return (deletar(pessoa.id)); };
        ...
        btEdit.id = "" + pessoa.id;
        btEdit.onclick = function (event) { return (preEdit(pessoa.id)); };
...
function deletar(id) {
    var index = novaLista.findIndex(function (pessoa) { return pessoa.id === id; });
...
function preEdit(id) {
    indexAltera = novaLista.findIndex(function (pessoa) { return pessoa.id === id; });
...
var btAlterar = document.getElementById('btAlterar');
btAlterar.onclick = function (event) { return (alterar()); };
function alterar() {
    var inputId = document.getElementById('inputId');
    var inputNome = document.getElementById('inputNome');
    var inputBio = document.getElementById('inputBio');
    ...
    if (inputId.value == "") {
        alert('Escolha um nome para editar.');
    }
...
btCancelar.onclick = function (event) { return (cancelar()); };
