const lista: Array<any> = [5, 9.8, "Alan", "José", 1000, 0.45, "Brasil"]

function retorno(lista: any) {  
    ...
    let media = (newList.reduce((soma: number, num: number) => soma += num, 0) / newList.length).toFixed(2); // Calcula a média
